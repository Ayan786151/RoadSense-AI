        ...
        if run_detect_btn and os.path.exists(selected_vid):
            ...
            if not cap.isOpened():
                ...
                while cap.isOpened() and frame_idx < max_f:
                    ...
                    # Compute actual live statistics
                ...
                st.session_state["last_video_results_interim"] = {
            ...
            if "last_video_results_interim" in st.session_state and st.session_state["last_video_results_interim"]["vid_name"] == os.path.basename(selected_vid):
                res_data = st.session_state["last_video_results_interim"]
                with metrics_container.container():
                    vk1, vk2 = st.columns(2)
